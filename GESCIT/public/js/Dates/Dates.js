...
const initDatesDataTable = async () => {
    try {
        ...
        const dtcolumns = ['Cliente', 'Folio', 'Estatus','Fecha de Solicitud', 'Fecha de Cita', 'Horario', 'Hora de Cita', 'Hora de Ingreso', 'Operacion', 'Línea de Transporte', 'Tipo de Transporte', 'Placa de Transporte ', 'Placa de Caja #1', 'Placa de Caja #2 ', 'Chofer', 'Producto', 'Volumen en Toneladas', 'Presentación']
        const columns = [
            {
                title: 'Acciones',
                data: 'Id',
